...
/**
 * Inventory tracks raw materials and consumables only. Finished
 * sellable items live in the Menu module — recipes link the two
 * (see `MenuItem.recipe`).
 */

export const SUPPLIERS: Supplier[] = [
  { id: "sup_blue", name: "Bluestone Coffee Roasters", contact: "Naomi Park", email: "naomi@bluestone.co", phone: "+1 510 555 0190", itemsSupplied: 5, rating: 4.8 },
  { id: "sup_dairy", name: "Valley Dairy Co.", contact: "Marcus Lee", email: "marcus@valleydairy.com", phone: "+1 510 555 0140", itemsSupplied: 4, rating: 4.6 },
  { id: "sup_bake", name: "Sweetcrumb Bakery", contact: "Priya Anand", email: "priya@sweetcrumb.com", phone: "+1 510 555 0121", itemsSupplied: 4, rating: 4.7 },
  { id: "sup_farm", name: "Greenfield Farms", contact: "Theo Walker", email: "theo@greenfield.com", phone: "+1 510 555 0133", itemsSupplied: 8, rating: 4.5 },
  { id: "sup_pkg", name: "Northwind Packaging", contact: "Hannah Brooks", email: "hannah@northwind.co", phone: "+1 510 555 0155", itemsSupplied: 4, rating: 4.4 },
  { id: "sup_meat", name: "Westridge Butchery", contact: "Connor Briggs", email: "connor@westridge.co", phone: "+1 510 555 0166", itemsSupplied: 3, rating: 4.6 },
];
...
export const INVENTORY: InventoryItem[] = [
  ...
  // ─── Bakery ingredients ───────────────────────────────────────
  { id: "inv_012", name: "Almond croissant dough", sku: "BAK-ACR", category: "Bakery", unit: "pcs", stock: 12, reorderLevel: 20, costPerUnit: 1.8, supplierId: "sup_bake", lastRestocked: daysAgo(1), expiresAt: daysAhead(2) },
  { id: "inv_013", name: "Butter croissant dough", sku: "BAK-BCR", category: "Bakery", unit: "pcs", stock: 18, reorderLevel: 24, costPerUnit: 1.4, supplierId: "sup_bake", lastRestocked: daysAgo(1), expiresAt: daysAhead(2) },
  { id: "inv_014", name: "Flour — all-purpose", sku: "BAK-FLR", category: "Bakery", unit: "kg", stock: 14, reorderLevel: 8, costPerUnit: 1.6, supplierId: "sup_farm", lastRestocked: daysAgo(20) },
  ...
  { id: "inv_025", name: "Lemons", sku: "PRD-LMN", category: "Produce", unit: "kg", stock: 2.4, reorderLevel: 2, costPerUnit: 2.8, supplierId: "sup_farm", lastRestocked: daysAgo(3), expiresAt: daysAhead(8) },
  { id: "inv_026", name: "Lettuce", sku: "PRD-LET", category: "Produce", unit: "pcs", stock: 14, reorderLevel: 10, costPerUnit: 1.4, supplierId: "sup_farm", lastRestocked: daysAgo(2), expiresAt: daysAhead(4) },

  // ─── Meat & deli ──────────────────────────────────────────────
  { id: "inv_027", name: "Smoked salmon", sku: "MET-SLM", category: "Meat", unit: "kg", stock: 1.2, reorderLevel: 1, costPerUnit: 36.0, supplierId: "sup_meat", lastRestocked: daysAgo(2), expiresAt: daysAhead(5) },
  { id: "inv_028", name: "Turkey breast — sliced", sku: "MET-TRK", category: "Meat", unit: "kg", stock: 2.0, reorderLevel: 2, costPerUnit: 18.0, supplierId: "sup_meat", lastRestocked: daysAgo(3), expiresAt: daysAhead(6) },
  { id: "inv_029", name: "Bacon", sku: "MET-BCN", category: "Meat", unit: "kg", stock: 1.6, reorderLevel: 1, costPerUnit: 14.0, supplierId: "sup_meat", lastRestocked: daysAgo(3), expiresAt: daysAhead(10) },
